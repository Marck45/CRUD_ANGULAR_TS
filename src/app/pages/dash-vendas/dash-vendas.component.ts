...
@Component({
  selector: 'app-dash-vendas',
  templateUrl: './dash-vendas.component.html',
  styleUrls: ['./dash-vendas.component.css']
})
export class DashVendasComponent implements AfterViewInit {
  ...
  title: string = 'Relatorio de Vendas'
